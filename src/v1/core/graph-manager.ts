...
import { createNodeRadiusCache, NodeRadiusCache } from '../utils/node-radius-cache';
...
export class GraphManager {
  ...
  public nodeRadiusCache: NodeRadiusCache | null = null;
  ...
  initializeManagers(): void {
    ...
    // Auto-enable node radius cache for performance optimization
    if (!this.nodeRadiusCache) {
      this.nodeRadiusCache = createNodeRadiusCache();
    }
  }
